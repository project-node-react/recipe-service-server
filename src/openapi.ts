...
export function generateOpenApiDocument() {
	...
	return generator.generateDocument({
		...
		tags: [
			...
			{
				name: "Users",
				description: "User profiles, avatars and follow relationships",
			},
			{
				name: "Recipes",
				description: "Recipe search, details, favorites and ownership",
			},
			{ name: "Categories", description: "Recipe categories" },
			{ name: "Ingredients", description: "Recipe ingredients" },
			{
				name: "Areas",
				description: "Cuisine areas (routes not currently mounted)",
			},
			{
				name: "Testimonials",
				description: "User testimonials (routes not currently mounted)",
			},
		],
	});
}
